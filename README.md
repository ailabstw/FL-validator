...
There are few things one will need to do before using the fl validator as below.
...
* 2. If you have implemented all interfaces in your code, then package it as a docker image.
...
## What will be validated ?
  * Four GPPC interface : DataValidation, TrainInit, LocalTrain, TrainFinish will be validated. You will know whether your image has successfully implemented the basic interface to fit our federated learning system. A report.json file will be created at */var/reports/report.json*
